...
namespace Restaurant_Management_System.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var myDbContext = _context.Orders.Include(o => o.Customer).Include(o => o.Menu).Include(o => o.User);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,MenuId,Quantity,OrderDate,TotalPrice,UserId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,CustomerId,MenuId,Quantity,OrderDate,TotalPrice,UserId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
